...
shoot_bow =   ItemWithDirection(x = -20*TILESIZE, y = -20*TILESIZE, tile_x_down = 0, tile_y_down = 16, tile_x_up = 112,  tile_y_up = 32,tile_x_left = 96, tile_y_left = 0, tile_x_right = 80, tile_y_right = 0, alpha = 14)
